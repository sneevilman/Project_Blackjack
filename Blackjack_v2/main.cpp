...
int main() {
    ...
    short          deck=52,     //number of cards in deck
                   ...
                   wins,        //total wins
                   losses,      //total losses
                   uTurn;       //determines whose turn it is
          ...
          do{
              ...
              drawV=rand()%13+1;
                  switch (drawV){
                      ...
                      if(uTurn==1){hAce++;}else{dhAce++;}dAce++;}break;    //Checks number of card taken from deck - if it's 4, defaults and 
                      case 2:if(d2!=4){crdType="a Two";
                      if(uTurn==1){h2++;}else{dh2++;}d2++;}break;           //rerolls drawV. If it's less than 4, add the card to your hand,
                      case 3:if(d3!=4){crdType="a Three";
                      if(uTurn==1){h3++;}else{dh3++;}d3++;}break;         //output the card type, and add to the number taken from the deck
                      case 4:if(d4!=4){crdType="a Four";
                      if(uTurn==1){h4++;}else{dh4++;}d4++;}break;
                      case 5:if(d5!=4){crdType="a Five";
                      if(uTurn==1){h5++;}else{dh5++;}d5++;}break;
                      case 6:if(d6!=4){crdType="a Six";
                      if(uTurn==1){h6++;}else{dh6++;}d6++;}break;
                      case 7:if(d7!=4){crdType="a Seven";
                      if(uTurn==1){h7++;}else{dh7++;}d7++;}break;
                      case 8:if(d8!=4){crdType="an Eight";
                      if(uTurn==1){h8++;}else{dh8++;}d8++;}break;
                      case 9:if(d9!=4){crdType="a Nine";
                      if(uTurn==1){h9++;}else{dh9++;}d9++;}break;
                      case 10:if(d10!=4){crdType="a Ten";
                      if(uTurn==1){h10++;}else{dh10++;}d10++;}break;
                      case 11:if(dJ!=4){crdType="a Jack";
                      if(uTurn==1){hJ++;}else{dhJ++;}dJ++;}break;
                      case 12:if(dQ!=4){crdType="a Queen";
                      if(uTurn==1){hQ++;}else{dhQ++;}dQ++;}break;
                      case 13:if(dK!=4){crdType="a King";
                      if(uTurn==1){hK++;}else{dhK++;}dK++;}break;
                   }    //card Table
